          ...
          <ul class="nav visible-xs" id="xs-menu">
            ...
            <div class="column col-sm-10 col-xs-11" id="main">
              ...
              <div class="col-sm-6">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <form>
                    <input type="text" name="choixVisibilite" id="choixVisibilite" value="Ancien"><br>
                    <input type="text" name="choixVisibilite" id="choixVisibilite" value="Nouveau"><br></label>
                    <input type="text" name="choixVisibilite" id="choixVisibilite" value="Confirmer">
                    <br>
                    <input type="button" id="ValiderVisibilite" value="Valider">
                  <form>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4>Modifier votre visibilité</h4>
                  </div>
                  <div class="panel-body">
                  <form>
                    <input type="radio" name="choixVisibilite" id="choixVisibilite" value="aucune">Aucune<br>
                    <input type="radio" name="choixVisibilite" id="choixVisibilite" value="amis">Vu par vos amis<br>
                    <input type="radio" name="choixVisibilite" id="choixVisibilite" value="tous" checked>Tout le monde
                    <br>
                    <input type="button" id="ValiderVisibilite" value="Valider">
                  <form>
                  </div>
